  ...
  .done(
    function(output, status, xhr) {
      ...
      if (output.hasOptOut) {
        ...
        modalOutput += '<div class="btn-group"><button type="button" class="btn btn-default addToBasketBtn loading" data-dismiss="modal" disabled>' + $('#continueShopping').attr('data-label') + '</button></div>';
        modalOutput += '<div class="btn-group"><a href="' + checkoutURL + '" class="btn btn-primary"><span class="glyphicon glyphicon-shopping-cart"></span>' + $('#proceedToCheckout').attr('data-label') + '</a></div>';
        modalOutput += '</div>';
